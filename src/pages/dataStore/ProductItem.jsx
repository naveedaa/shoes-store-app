...
const ProductItem = ({product}) => {
    ...
    return ( 
        <div className="card card-body">
            <img style={{display: "block", borderRadius: "30",  margin: "0 auto 10px", maxHeight: "200px", justifyContent: "space-around" }} className="img-fluid" 
            ...
            <div className="text-right">
                ...
                }   
                {
                    ...
                    className="btn btn-outline btn-warning btn-sm">Add more</button>
                }
